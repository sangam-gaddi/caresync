    ...
    <div className="min-h-screen bg-[#080c14] overflow-x-hidden">
      ...
      <section className="py-20 px-4">
        <div className="max-w-xl mx-auto text-center">
          <div className="p-8 rounded-3xl os-glass relative overflow-hidden">
            <div className="absolute inset-0 bg-glow-radial pointer-events-none" />
            <div className="relative">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-500 to-purple-500 flex items-center justify-center mx-auto mb-4 animate-float">
              ...
              <p className="text-white/40 text-sm mb-6">
                Takes 2 minutes. No credit card. See your 3D body health score instantly.
              </p>
              <button
                onClick={() => router.push("/onboarding")}
                className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold hover:from-cyan-400 hover:to-blue-400 transition-all shadow-[0_0_40px_rgba(0,229,255,0.2)]"
              >
